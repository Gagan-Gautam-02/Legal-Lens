...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a legal expert analyzing Terms of Service documents. Identify and explain the following key clauses from the document below, in this language: {{{language}}}\n\n- Limitation of Liability\n- Intellectual Property Rights\n- User Conduct\n
