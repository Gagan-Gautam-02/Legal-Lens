          ...
          <div className="container mx-auto w-full max-w-6xl px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                Get personalized legal requirements for your business, e-commerce, and startups. Our AI provides clear, required legal documents and actions to help your venture succeed in the future.
                </p>
                <Button asChild size="lg">
              ...
              <div className="bg-card p-8 rounded-lg shadow-lg">
                ...
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-center gap-3">
                    ...
                    <span>Legal Requirements (New Policies, Taxation)</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-green-500" />
